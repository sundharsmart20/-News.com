...
const Science=(props)=>{
	...
	useEffect(()=>
		Service.getScience().then((res)=>{
		setTech(res.data.articles)
	}),[])

	console.log("the tech",science)
	...
	return(
		...
		<p class="card-text"><small class="text-muted">#Science</small></p>
				{
				...
				science.map((techies,index)=>{
					...
					<div  key={techies.description} class=" card mb-3 shadow p-3 mb-5 bg-body rounded" style={{maxWidth: "540px;"}}>
					  <div class="row g-0">
						...
						<a class="resp-sharing-button__link" href="https://atnews.herokuapp.com/Science" target="_blank" rel="noopener" aria-label="Share on Facebook">
						  <div class="resp-sharing-button resp-sharing-button--facebook resp-sharing-button--large"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
						    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z"/></svg>
						    </div></div>
						</a>

						<a class="resp-sharing-button__link" href="https://atnews.herokuapp.com/Science" target="_blank" rel="noopener" aria-label="Share on WhatsApp">
